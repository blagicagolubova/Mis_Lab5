...
class _MainScreenState extends State<MainScreen> {
  ...
  List<ExamItem> _examItems = [
    ExamItem(id: nanoid(5), naslov: "Menadzment informaciski sistemi", datum: DateTime.parse('2022-03-02 16:00')),
    ExamItem(id: nanoid(5), naslov: "Mobilni informaciski sistemi", datum: DateTime.parse('2022-03-03 16:00'))
  ];
